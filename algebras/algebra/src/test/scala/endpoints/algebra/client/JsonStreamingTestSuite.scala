...
trait JsonStreamingTestSuite[T <: ChunkedJsonEntitiesTestApi] extends ClientTestBase[T] {
  ...
  /**
    ...
    */
  def callStreamedEndpoint[A, B](endpoint: Endpoint[A, Chunks[B]], req: A): Future[Seq[B]]
